...
# NOAA Change Log
# Updated 11.05.18: NOAA: "Online_Resource_Description" to "Description"
# Updated 11.05.18: LiPD: "archiveType" -> "NOAAdataType" / NOAA: "Archive_Type" to "Data_Type"
# Updated 11.05.18: LiPD: "studyName" -> "NOAAstudyName"
# Updated 11.05.18: LiPD: LiPD: "location" -> "gcmdLocation", NOAA: "gcmdLocation" -> "Location"
# Updated 11.05.18: LiPD: LiPD & NOAA: Removed "country" field. Unnecessary.
...
NOAA_KEYS_BY_SECTION = {
    "Top": ["Study_Name", 'Online_Resource', "Online_Resource_Description", 'Original_Source_URL', "Original_Source_URL_Description", 'Data_Type',
    ...
    "Variables": ["shortname", "what", "material", "error", "units", "seasonality", "dataType", "detail", "method",
                  "dataFormat", "additional"],
    "Data": ["Missing_Value"],
...
LIPD_NOAA_MAP_BY_SECTION = {
    "Top": {
        "NOAAstudyName": "Study_Name",
        'onlineResource': 'Online_Resource',
        "onlineResourceDescription": "Description",
        "url": "Original_Source_URL",
        "dataUrl": "Original_Source_URL",
        "originalSourceUrl": "Original_Source_URL",
        'originalSourceUrlDescription': 'Original_Source_URL_Description',
        "NOAAdataType": "Data_Type",
    ...
    "Variables": {
        'description': 'what',
        'detail': 'detail',
        'NOAAdataType': 'dataType',
        'error': 'error',
        'units': 'units',
        'variableName': 'shortname',
        'measurementMaterial': 'material',
        'measurementMethod': 'method',
        'NOAAseasonality': 'seasonality',
        'NOAAdataFormat' : 'dataFormat',
        "notes": "notes",
...
LIPD_NOAA_MAP_FLAT = {
    ...
    # 11.05.18 - NOAA Requested Changes
    'NOAAstudyName': 'Study_Name', # Specific NOAA study name
    'NOAAdataType' : 'Data_Type',  # Replaced archiveType
    'NOAAdataFormat': 'Data_Format', # C or N option in variable description
    'originalSourceUrlDescription': "Original_Source_URL_Description",
    'gcmdLocation': 'Location',
    'NOAAseasonality': 'Seasonality', # Part of 9 part variable description.
